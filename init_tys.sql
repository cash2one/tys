...
CREATE TABLE `md_chat_class` (
  ...
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=188001 DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for `md_push_tag`
-- ----------------------------
DROP TABLE IF EXISTS `md_push_tag`;
CREATE TABLE `md_push_tag` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of md_push_tag
-- ----------------------------

-- ----------------------------
-- Table structure for `md_question`
-- ----------------------------
DROP TABLE IF EXISTS `md_question`;
...
CREATE TABLE `md_user` (
  ...
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=126681001 DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for `rel_question_answer`
-- ----------------------------
DROP TABLE IF EXISTS `rel_question_answer`;
CREATE TABLE `rel_question_answer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `is_deleted` tinyint(4) NOT NULL,
  `created_by` int(11) DEFAULT NULL,
  `create_time` timestamp NOT NULL DEFAULT '2016-01-01 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
  `updated_by` int(11) DEFAULT NULL,
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Records of rel_question_answer
-- ----------------------------
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('-1', 'admin', 'b594510740d2ac4261c1b2fe87850d08', null, null, '系统管理员', null, null, null, null, null, '0', null, null, null, '0', '2014-12-28 21:52:51', null, '2016-03-10 13:38:43', null);
