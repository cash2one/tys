package com.tys.im.tls_sigature;
...
import com.tys.im.base64_url.Base64_url;
...
public class TlsSigature {
	...
	public static void main(String[] args) {
		try {
			...
			String privStr = "-----BEGIN PRIVATE KEY-----\n"
					+ "MIGEAgEAMBAGByqGSM49AgEGBSuBBAAKBG0wawIBAQQg2KlRBhmKG8l5nxpV6fg3\n"
					+ "1PdJbd1Lk/aAkazW1LEUwhqhRANCAARi+rIJgHDjMCVhv5VSf6uVL98cULhHDkGr\n"
					+ "RVR/R9hql61FRwMiEagJ8BzV5zb/8S4Ue9LZFTIPDqaueBfsQWOs\n" + "-----END PRIVATE KEY-----";
			...
			// generate signature
			GenTLSSignatureResult result = GenTLSSignatureEx(1400007385, "126681005", privStr);
			...
			// check signature
			CheckTLSSignatureResult checkResult = CheckTLSSignatureEx(result.urlSig, 1400007385, "admin", pubStr);
	...
	public static GenTLSSignatureResult GenTLSSignature(long expire, String strAppid3rd, long skdAppid,
		...
		try {
			...
			String sigTLS = new String(Base64.encodeBase64(signatureBytes));
