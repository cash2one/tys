...
public class DeleteTag {
	public static void main(String[] args) 
		...
		String apiKey = "D3qougO1m4wfyEbxoL1xr8Gv";
		String secretKey = "aOTXdT4pt5mA1uqRjAbyjauwUpow3VP0";
		...
		deleteTag(pushClient);
	}

	private static void deleteTag(BaiduPushClient pushClient) throws PushClientException, PushServerException {
		try {
			// 4. specify request arguments
			DeleteTagRequest request = new DeleteTagRequest().addTagName(
					"tag_class_6").addDeviceType(new Integer(3));
			// 5. http request
